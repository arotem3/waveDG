...
{
    template <>
    DivF1D<true>::DivF1D(const Mesh1D& mesh, const QuadratureRule * basis, const QuadratureRule * quad)
        : n_colloc(basis->n),
          n_elem(mesh.n_elem()),
          quad(basis),
          D(n_colloc, n_colloc)
    ...
    template <>
    DivF1D<false>::DivF1D(const Mesh1D& mesh, const QuadratureRule * basis, const QuadratureRule * quad_)
        : n_colloc(basis->n),
          n_elem(mesh.n_elem()),
    ...
    template <>
    DivF2D<true>::DivF2D(const Mesh2D& mesh, const QuadratureRule* basis, const QuadratureRule *quad_)
        : n_colloc{basis->n},
          n_elem{mesh.n_elem()},
          quad{basis},
          n_quad{basis->n},
    ...
    template <>
    DivF2D<false>::DivF2D(const Mesh2D& mesh, const QuadratureRule* basis, const QuadratureRule *quad_)
        : n_colloc{basis->n},
          n_elem{mesh.n_elem()},
          quad{quad_ ? quad_ : QuadratureRule::quadrature_rule(2*n_colloc)},
          n_quad{quad->n},
