/** @file cl2d-mpi.cpp
 *  @brief Example driver for solving Euler's equation for compressible fluid dynamics in 2D with MPI
 * 
...
int main(int argc, char ** argv)
{
    ...
    constexpr int n_var = 4; // dimension of Euler's equations: (rho, u, v, E)
    ...
    Mesh2D mesh;
    if (rank == 0)
        mesh = Mesh2D::uniform_rect(nx, 0.0, 10.0, ny, -6.0, 6.0);
    mesh.distribute();
    ...
    FaceVector boundary_faces(n_var, mesh, FaceType::BOUNDARY, basis);
    auto uB = boundary_faces.as_tensor();
